...
###################################################################################
PRIMARY_CONNECTION="user=${PGUSER} passfile=''/var/lib/edb-as/.pgpass''"
